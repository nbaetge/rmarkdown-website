...
\
\
<center>![](movies/sp2319.mov){ width=60% }</center>
\
\
<h4 style="font-size: 16px; color: #AEC96F"> A short reel from a 28 day research cruise off California where we conducted microbial incubation experiments with wildfire ash leachates. </h4>
